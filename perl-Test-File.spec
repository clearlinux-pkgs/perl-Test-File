...
Version  : 1.445
Release  : 16
URL      : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Test-File-1.445.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Test-File-1.445.tar.gz
...
%prep
%setup -q -n Test-File-1.445
cd %{_builddir}/Test-File-1.445
...
cp %{_builddir}/Test-File-1.445/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-File/d996772fbcb7a7036df0282cb4cc201eefed0d59
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Test/File.pm
