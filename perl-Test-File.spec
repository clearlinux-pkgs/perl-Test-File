...
Source0  : https://cpan.metacpan.org/authors/id/B/BD/BDFOY/Test-File-1.447.tar.gz
...
%prep
%setup -q -n Test-File-1.447
cd %{_builddir}/Test-File-1.447
...
cp %{_builddir}/Test-File-1.447/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-File/d996772fbcb7a7036df0282cb4cc201eefed0d59
if test -f Makefile.PL; then
