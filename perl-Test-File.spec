...
cp %{_builddir}/Test-File-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-File/ef5f959e304573aa97e8db7700628f609df996f5 || :
if test -f Makefile.PL; then
