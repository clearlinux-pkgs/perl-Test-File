...
cp %{_builddir}/Test-File-1.443/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-File/774ccaf289cbffbe61fef09be995bc0a0e97d0d1
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Test-File/774ccaf289cbffbe61fef09be995bc0a0e97d0d1

%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/Test/File.pm
